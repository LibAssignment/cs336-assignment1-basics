...
def run_scaled_dot_product_attention(
    ...
    from cs336_basics.modules import _scaled_dot_product_attention
...
def run_cross_entropy(
    ...
    m = CrossEntropy()
    return m.forward(inputs, targets)
...
def run_get_lr_cosine_schedule(
    ...
    from cs336_basics.optimizer import _lr_cosine
    return _lr_cosine(it, min_learning_rate, max_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_load_checkpoint(
    ...
    return _load_checkpoint(src, model, optimizer)["iteration"]
